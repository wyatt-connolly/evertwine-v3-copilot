    ...
    <section className="min-h-screen flex flex-col xl:flex-row overflow-hidden">
      ...
      <div className="h-[50vh] xl:h-auto w-full xl:w-1/2 xl:order-1 bg-black p-6 md:p-12 xl:p-20 flex items-center">
        <div className="w-full">
          ...
          >
            <Lock className="h-5 w-5 md:h-7 md:w-7 xl:h-6 xl:w-6 text-black" />
          </div>
          ...
          >
            Control exactly what you share and with whom. Evertwine puts you in charge of your data with granular
            privacy controls and transparent data practices.
          </p>
        </div>
      </div>
    </section>
